...
const AddProducts = () => {
  ...
  const submitHandler = async (e) => {
    e.preventDefault();
    // You can send this product data to your API
    ...
    <div className="flex-1 h-[95vh] overflow-y-auto no-scrollbar bg-gray-50 p-6">
      <form onSubmit={submitHandler} className="space-y-8 max-w-3xl mx-auto">
        ...
        <div className="flex flex-col space-y-2">
          ...
          <label className="cursor-pointer">
            ...
            <div className="w-32 h-32 border-2 border-dashed border-gray-400 flex items-center justify-center rounded-lg overflow-hidden bg-white">
              <img 
                src={file ? URL.createObjectURL(file) : "https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/e-commerce/uploadArea.png"} 
                alt="upload" 
        ...
        <div className="flex flex-col gap-2">
          <label className="text-sm font-medium text-gray-700" htmlFor="product-name">Product Name</label>
          <input 
            id="product-name" 
            type="text" 
        ...
        {/* Product Description */}
        <div className="flex flex-col gap-2">
          <label className="text-sm font-medium text-gray-700" htmlFor="product-description">Product Description</label>
          <textarea 
        ...
        <div className="flex flex-wrap gap-6">
          <div className="flex flex-col gap-2 flex-1 min-w-[150px]">
            <label className="text-sm font-medium text-gray-700" htmlFor="product-price">Product Price</label>
            <input 
              id="product-price" 
              type="number" 
              placeholder="0" 
