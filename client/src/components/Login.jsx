...
const Login = () => {
    let {setshowUserLogin} = useAppContext()
    ...
    return (
       ...
       <button onClick={()=>setshowUserLogin(false)} className="bg-[#E9AB54] hover:bg-[#926526] transition-all text-white w-full py-2 rounded-md cursor-pointer">
